  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-slate-50 text-slate-950 lg:grid lg:grid-cols-[260px_1fr] xl:grid-cols-[280px_1fr]">
      ...
      <div className="relative z-10 min-w-0 lg:col-start-2">
        ...
        <main className="relative z-10 mx-auto w-full max-w-7xl px-3 py-5 sm:px-6 lg:px-8 lg:py-10">
          <div className="min-w-0">
            <h1 className="break-words text-2xl font-bold tracking-tight sm:text-4xl xl:text-5xl">
    ...
    <div className="mt-6 grid min-w-0 gap-4 sm:mt-8 sm:gap-5 xl:grid-cols-[1fr_1.1fr]">
        ...
        <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(180px,220px)_1fr] lg:items-center">
          <div className="relative mx-auto flex aspect-square w-full max-w-48 items-center justify-center rounded-full bg-teal-50 sm:max-w-64">
            ...
            <div className="relative flex aspect-square w-[68%] flex-col items-center justify-center rounded-full bg-white">
              <span className="text-3xl font-bold text-teal-800 sm:text-5xl">
                {percentage}%
              </span>
          ...
          <div>
            ...
            <h2 className="mt-6 break-words text-2xl font-bold tracking-tight sm:text-5xl">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-xl font-bold sm:text-2xl">Share Your Case</h2>
        </div>
        ...
        <div className="mt-8 min-w-0">
          ...
          <div className="mt-2 flex min-w-0 overflow-hidden rounded-lg border border-slate-300 bg-slate-50">
...
function ProgressHubSection({
  ...
  return (
    <div className="grid gap-5">
      {caseSelector}
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm sm:p-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0">
            ...
            <h2 className="mt-5 break-words text-xl font-bold sm:text-3xl">
          ...
          <div className="rounded-xl border border-teal-100 bg-teal-50 p-4 text-teal-950 sm:p-5 lg:min-w-72">
            <p className="text-sm font-bold">Funding progress</p>
            <p className="mt-2 text-3xl font-bold sm:text-4xl">{paidPercentage}%</p>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm sm:p-8">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-xl font-bold sm:text-2xl">Recent donors</h2>
...
function SharingToolkitSection({
  ...
  return (
    <div className="mt-6 grid min-w-0 gap-4 sm:mt-8 sm:gap-5">
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm sm:p-8">
        <div className="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(280px,340px)] lg:items-start">
          ...
          <div className="min-w-0 rounded-xl border border-teal-100 bg-teal-50 p-4 sm:p-5">
            <p className="text-sm font-bold text-teal-950">Campaign link</p>
            <div className="mt-3 flex min-w-0 overflow-hidden rounded-lg border border-teal-100 bg-white">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-sm sm:p-8">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-xl font-bold sm:text-2xl">Share on social media</h2>
            <p className="mt-1 text-sm text-slate-600">
...
function PlaceholderSection({
  ...
  return (
    <section className="mt-6 rounded-2xl border border-slate-200 bg-white/95 p-5 text-center shadow-sm sm:mt-8 sm:p-10">
      <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-teal-50 text-teal-800">
        <Icon className="h-7 w-7" />
      </div>
      <h2 className="mt-5 text-xl font-bold sm:text-2xl">{placeholder.title}</h2>
      <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-600 sm:text-base">
        {placeholder.body}
      </p>
    </section>
...
function NoMedicalCaseState({
  ...
  if (declaration) {
    return (
      <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:mt-8 sm:p-8 lg:p-10">
        <div className="mx-auto max-w-3xl rounded-xl border border-teal-100 bg-teal-50/60 p-4 sm:p-5">
  ...
  return (
    <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 text-center shadow-sm sm:mt-8 sm:p-8 lg:p-10">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-teal-50 text-teal-800">
        <ShieldCheck className="h-8 w-8" />
      </div>
      <h2 className="mt-6 break-words text-xl font-bold sm:text-3xl">
